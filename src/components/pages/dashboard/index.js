...
const Dashboard = () => {
  ...
  const fetchDashboardData = async (e) => {
    ...
    console.log('fetchDashboardDataviewResponse:', fetchDashboardDataviewResponse)
    if (fetchDashboardDataviewResponse.hasError) {
      console.log('Cant fetch Dashboard Data -> ', fetchDashboardDataviewResponse.errorMessage);
      ...
      dashboardData.salesChart.forEach(e => {
        salesChartData.labels.unshift(formatDate(formatDate(e.invoice_datetime)));
      ...
      {!loading &&
        ...
        <div className='page__content'>
                ...
                <Row gutter={16, 16}>
                  <Col xs={24} sm={12} md={6}>
                    <div class="info data-info">
                      <div class="data">
                        <span class="price">{parseFloat(salesToday.sales_today).toFixed(2)}</span>
                      </div>
                      <div class="row">
                        <p>Sales Today</p>
                      </div>
                  ...
                  <Col xs={24} sm={12} md={6}>
                    <div class="info data-info">
                      <div class="data">
                        <span class="price">{parseInt(salesToday.sale_count)}</span>
                      </div>
                      <div class="row">
                        <p>Sales Count</p>
                      </div>
                  ...
                  <Col xs={24} sm={12} md={6}>
                    <div class="info data-info">
                      <div class="data">
                        <span class="price">{parseInt(salesToday.product_sold)}</span>
                      </div>
                      <div class="row">
                        <p>Product Sold</p>
                      </div>
                  ...
                  <Col xs={24} sm={12} md={6}>
                    <div class="info data-info">
                      <div class="data">
                        <span class="price">{parseFloat(salesToday.gross_profit).toFixed(2)}</span>
                      </div>
                      <div class="row">
                        <p>Gross Profit</p>
                      </div>
          ...
          <div className='page__section charts'>
            <div className='sales'>
              <h2 className="pie-chart-heading">Sales History</h2>
