...
const SalesSummary = () => {
  ...
  const fetchSalesSumaryData = async () => {
    ...
    const salesSummaryResponse = await ReportsApiUtil.viewSalesSummery(startDate, endDate, ecommerce);
    ...
    if (salesSummaryResponse.hasError) {
      ...
      salesDataMops.discounts = parseFloat(salesSummaryResponse.invoice_discount);
      ...
      <div className='page reports'>
        ...
        <div className='page__content'>
          <div className='action-row'>
            ...
            />
            <Button type='primary' icon={<BarsOutlined />} onClick={fetchSalesSummary}>
              Fetch
            </Button>
          </div>
