...
const ProductHistory = () => {
  ...
  const [productMovementTableCheck, setProductMovementTableCheck] = useState(
    false
  );
  const [productMovementReportData, setProductMovementReportData] = useState(
    null
  );
  ...
  function export_table_to_csv(html, filename) {
    ...
    var rows = document.querySelectorAll(
      "div#product_movement_report_data_table  tr"
    );
  ...
  const DownloadToCsv = (e) => {
    if (productMovementReportData) {
      var html = document.getElementById("product_movement_report_data_table")
        .innerHTML;
    ...
    <div className='page reports'>
      ...
      <div className='page__content'>
        <div className='page__form'>
          ...
          {variantsTableCheck &&
            productMovementTableCheck &&
            productMovementReportData && (
              <div className='table'>
                <div className='form__section__header'>
