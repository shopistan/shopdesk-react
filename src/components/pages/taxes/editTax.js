      ...
      <div className="page__content">
        <div className="page__form">
          <Form
            ...
            layout="vertical"
            initialValues={{
              tax_name: history.location.data
                ? history.location.data.tax_name
                : "",
              tax_value: history.location.data
                ? history.location.data.tax_value
                : "",
            }}
            onFinish={onFinish}
